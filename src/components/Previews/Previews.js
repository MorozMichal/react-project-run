...
class Previews extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if ((prevState.year !== year && month === "00" && region === "all") || (prevState.month !== month && region === "all" && month === "00")) {
            const allDateAllRegion = [...racing]
            this.setState({
                year: yearNow,
        ...
        else if (prevState.region !== region && region === "all" && month === "00") {
            const allDateAllRegion = [...racing]
            this.setState({
                racingMonth: allDateAllRegion,
                disabled: true
        ...
        else if ((region === "all" && prevState.region !== region) || (prevState.month !== month && region === "all") || (prevState.year !== year && region === "all")) {
            const allRegionOneDate = racing.filter(array => array.date >= dateMin && array.date <= dateMax && array.region)
            this.setState({
